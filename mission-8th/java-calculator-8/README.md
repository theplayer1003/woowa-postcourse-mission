...
---
# 주의사항
- 과제 진행 요구사항, 기능 요구 사항, 프로그래밍 요구 사항이 존재한다
- 기능 구현 전에 반드시 기능 목록을 만들고 기능 작성 단위로 커밋한다
- 기능 요구 사항에 기재되지 않은 부분은 ***알아서 판단 후 작성한다***
- 요구 사항에 명시된 출력 형식을 반드시 지켜라
- `./gredlew clean test` 반드시 체크